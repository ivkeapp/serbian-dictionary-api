...
return [
    ...
    // API Endpoints
    'api.words.description' => 'Добијте пагинирану листу српских речи са опцијама за филтрирање',
    ...
    'api.words.param.random' => 'Рандомизујте редослед резултата',
    ...
    'api.words.example.1' => 'Добијте првих 10 речи из малог скупа података',
    ...
    'api.names.description' => 'Добијте српска имена са информацијама о роду и вокативним облицима',
    ...
    'api.names.param.random' => 'Рандомизујте редослед резултата',
    'api.names.param.page' => 'Број странице за пагинацију',
    'api.names.param.limit' => 'Број резултата по страници',
    'api.names.example.1' => 'Добијте 15 мушких имена',
    ...
    'api.surnames.description' => 'Добијте српска презимена са варијантама на латиници и ћирилици',
    'api.surnames.param.starts_with' => 'Филтрирајте презимена која почињу одређеним словима',
    'api.surnames.param.random' => 'Рандомизујте редослед резултата',
    ...
    'api.random.description' => 'Добијте насумичан унос из било ког типа скупа података',
    'api.random.param.type' => 'Тип уноса: word, name или surname (обавезно)',
    'api.random.example.1' => 'Добијте насумичну српску реч',
    'api.random.example.2' => 'Добијте насумично српско име са вокативом',
    'api.random.example.3' => 'Добијте насумично српско презиме',
